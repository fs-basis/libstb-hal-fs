...
AC_ARG_WITH(boxtype,
	AS_HELP_STRING([--with-boxtype], [valid values: tripledragon, spark, generic, armbox, duckbox, spark7162, mipsbox]),
	[case "${withval}" in
		tripledragon|generic|armbox)
			BOXTYPE="$withval"
		;;
		spark|spark7162)
			BOXTYPE="spark"
		...
		tf*)
			...
			BOXMODEL="$withval"
		;;
		hd51|bre2ze4k|vusolo4k|vuduo4k|vuduo4kse|vuultimo4k|vuzero4k|vuuno4kse|vuuno4k|h7)
			BOXTYPE="armbox"
			BOXMODEL="$withval"
		;;
		vuduo)
